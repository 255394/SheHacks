...
#define WLAN_SSID       "vivo 1610" // put your Router SSID  
#define WLAN_PASS       "aadi255394" // put your Router password

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                   // use 8883 for SSL
#define AIO_USERNAME    "Katrax" // put your Adafruit i/o Username 
#define AIO_KEY         "fce285f1cabf4799b5d6ced17cd60be1" // put the Adafruit io Key for Account authentication
...
void setup() {
  ...
  delay(10); 
  pinMode(D0,OUTPUT); // initializes port registers of D0 or GPIO 16
  pinMode(D1,OUTPUT); // initializes port registers of D1 or GPIO 5
...
void loop() {
  ...
  {  
    if (subscription == &light)
    {
      ...
      {
          digitalWrite(D0,LOW); // switches off Light
          delay(500);
      }
      
      else if ( ((char *)light.lastread)[1] == 'N' )
      {
          digitalWrite(D0,HIGH);// switches on Light
          delay(500);
      }    
